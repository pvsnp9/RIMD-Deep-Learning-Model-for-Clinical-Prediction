...
args = {'epochs': 100, 'batch_size': 80, 'input_size': 104, 'model_type': 'RIMDecay', 'hidden_size': 104, 'num_rims': 5,
        ...
        'improvement_threshold': 0.0001, 'is_tuning': True, 'balance': False, 'is_cbloss': False, 'cb_beta': 0.95}
...
tuned_args = {
    ...
    "GRUD": {
        ...
        'input_dropout': 0.20816385459954448},
    "RIMDCB": {'epochs': 100, 'batch_size': 64, 'static_features': 16, 'need_data_preprocessing': False, 'raw_data_file_path': 'data/mimic_iii/test_dump/decay_data_20926.npz', 'processed_data_path': 'data/50_percent/', 'input_file_path': 'data/mimic_iii/test_dump/decay_data_20926.npz', 'decay_input_file_path': 'data/mimic_iii/test_dump/decay_data_20926.npz', 'max_no_improvement': 35, 'improvement_threshold': 0.0001, 'is_tuning': True, 'balance': False, 'is_cbloss': True, 'cb_beta': 0.9574429070469261, 'mask': True, 'mask_size': 104, 'delta_size': 104, 'input_size': 104, 'model_type': 'RIMDCB', 'hidden_size': 104, 'num_rims': 6, 'lr': 0.00014853105902639955, 'rnn_cell': 'LSTM', 'input_key_size': 64, 'input_value_size': 32, 'input_query_size': 64, 'num_input_heads': 2, 'input_dropout': 0.20141457179322433, 'comm_key_size': 32, 'comm_value_size': 104, 'comm_query_size': 32, 'num_comm_heads': 2, 'comm_dropout': 0.10984109555730687, 'active_rims': 4}
}
